...
public class App {
    public static void main(String[] args) {
        ...
        HistorialMedico historialMedico1 = new HistorialMedico(
            LocalDate.now(), "Rabia", "Acetaminofen", 
            "La mascota estaba rabiosa", veterinario1
        );
        
        HistorialMedico historialMedico2 = new HistorialMedico(
            LocalDate.now(), "Ceguera", "Gotas", 
            "La mascota no podia ver", veterinario2
        );
